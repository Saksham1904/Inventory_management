        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={changehandler}
              value={data.password}
              className="mb-2 py-3 px-3 text-2xl ml-[60px] font-outfit font-regular opacity-62 text-dgreen bg-grey rounded-2xl w-391"
            ></input>
            <input
              required
              type="password"
          ...
          <div>
            <button className="w-150 mt-8 mb-16 ml-[181px] text-2xl bg-bluee hover:bg-opacity-50 text-white font-outfit font-medium py-3 px-2.5 rounded-full">
              Sign Up
            </button>
          </div>
        </form>
